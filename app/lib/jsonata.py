...
class JSONataTimeoutError(JSONataError):
    def __init__(self, expression: str, timeout_seconds: float, path: Optional[str] = None):
        super().__init__(f"Evaluation timed out after {timeout_seconds}s", expression, path)
