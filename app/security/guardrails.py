...
from app.models.services import ExpertService, WorkflowService


def ensure_service_can_use_expert(session: Session, service_id: int, expert_id: int) -> None:
    """
...
def ensure_service_can_use_workflow(session: Session, service_id: int, workflow_id: int) -> None:
    """
