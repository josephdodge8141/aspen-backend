...
def add_expert_workflow_links(
    session: Session, expert_id: int, workflow_ids: list[int]
) -> dict:
    ...
    for workflow_id in workflow_ids:
        ...
        if not existing:
            expert_workflow = ExpertWorkflow(
                expert_id=expert_id, workflow_id=workflow_id
            )
            session.add(expert_workflow)
...
def remove_expert_workflow_link(
    session: Session, expert_id: int, workflow_id: int
) -> bool:
...
def add_expert_service_links(
    session: Session, expert_id: int, service_ids: list[int]
) -> dict:
...
def remove_expert_service_link(
    session: Session, expert_id: int, service_id: int
) -> bool:
