...
class TestServiceSegments:
    def test_create_segment_success(self, client, test_data, auth_headers):
    ...
    def test_create_segment_duplicate_name(self, client, test_data, auth_headers, db_session):
    ...
    def test_create_segment_service_not_found(self, client, test_data, auth_headers):
        """Test creating segment for non-existent service."""
        request_data = {"name": "Test Segment"}

        response = client.post(
            "/api/v1/services/99999/segments",
            json=request_data,
            headers=auth_headers
        )
    ...
    def test_list_segments(self, client, test_data, auth_headers, db_session):
        ...
        response = client.get(f"/api/v1/services/{service_id}/segments", headers=auth_headers)
    ...
    def test_list_segments_service_not_found(self, client, test_data, auth_headers):
        """Test listing segments for non-existent service."""
        response = client.get("/api/v1/services/99999/segments", headers=auth_headers)
        assert response.status_code == 404

    def test_delete_segment_success(self, client, test_data, auth_headers, db_session):
        ...
        response = client.delete(
            f"/api/v1/services/{service_id}/segments/{segment.id}",
            headers=auth_headers
        )
    ...
    def test_delete_segment_not_found(self, client, test_data, auth_headers):
        """Test deleting non-existent segment."""
        service_id = test_data["service"].id
        
        response = client.delete(
            f"/api/v1/services/{service_id}/segments/99999",
            headers=auth_headers
        )
    ...
    def test_delete_segment_wrong_service(self, client, test_data, auth_headers, db_session):
    ...
    def test_segments_allow_same_name_different_services(self, client, test_data, auth_headers, db_session):
    ...
    def test_unauthorized_access(self, client):
        ...
        # Test create
        response = client.post("/api/v1/services/1/segments", json={"name": "Test"})
        assert response.status_code == 401

        # Test list
        response = client.get("/api/v1/services/1/segments")
        assert response.status_code == 401

        # Test delete
        response = client.delete("/api/v1/services/1/segments/1")
        assert response.status_code == 401 